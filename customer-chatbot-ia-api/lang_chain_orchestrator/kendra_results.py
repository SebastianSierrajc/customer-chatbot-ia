...
def kendra_query(kclient, kquery, kindex_id, kcount, AttributeFilter):
    response = kclient.query(IndexId=kindex_id, QueryText=kquery.strip(), AttributeFilter=AttributeFilter)
