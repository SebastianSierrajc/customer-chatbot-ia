...
class KendraIndexRetriever(BaseRetriever):
    ...
    def __init__(self, kendraindex, awsregion, k=3, return_source_documents=False, language_code="es"):
    ...
    def get_relevant_documents(self, query: str) -> List[Document]:
        ...
        docs = kendra_query(self.kclient, query, self.kendraindex, self.k, AttributeFilter=AttributeFilter)
        return docs
